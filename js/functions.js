...
jQuery(function ($) {
   ...
   ====================================== */
    ...
    if ($("#dhillon").length) {
        var app = document.getElementById("dhillon");
        var dhillon = new Typewriter(app, {
            loop: true
        });
        dhillon.typeString('With dual expertise, we stand as your global partner safeguarding the rights of filmmakers, artists, and ').pauseFor(2000).deleteAll()
        dhillon.typeString('creators through Entertainment Law, and building safer, supported, entrusted workplaces with POSH-aligned ').pauseFor(2000).deleteAll()
        dhillon.typeString('compliance frameworks.').start();
            
    }

    if ($("#law").length) {
        var app = document.getElementById("law");
        var typewriter = new Typewriter(app, {
            loop: true
        });
        typewriter.typeString('Where Law Meets Creativity and <br>Protection').pauseFor(2000).deleteAll()
    ...
    if ($("#typewriting").length) {
        ...
        typewriter.typeString('Law Meets Creativity and Protection').pauseFor(2000).deleteAll()
        typewriter.typeString('Regulatory & Compliance').pauseFor(2000).deleteAll()
        typewriter.typeString('Dispute Resolution').pauseFor(2000).deleteAll()
        typewriter.typeString('Corporate & Commercial Advisory').pauseFor(2000).deleteAll()
        typewriter.typeString('Intellectual Property (IP) & Rights Protection').pauseFor(2000).deleteAll()
        typewriter.typeString('Film, Media & Digital Rights').pauseFor(2000).deleteAll()
        typewriter.typeString('Contracts & Agreements').pauseFor(2000).start();
    ...
    if ($("#personal").length) {
        ...
        personal.typeString('Dhillon Solicitors: Where').pauseFor(2000).start();
